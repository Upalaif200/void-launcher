...
(function initBackground() {
    ...
    try {
        ...
        console.warn('[BG] THREE.js no disponible, usando CSS fallback:', e.message);
        document.documentElement.style.backgroundColor = '#07040f';
        document.body.style.background = 'linear-gradient(180deg, #010005, #050015, #0a0030, #150060, #200080)';
        return;
    }
    ...
    let scene, camera, renderer, stars, edgeMat, vertMat, glowPoints;
    ...
    try {
        ...
        edgeMat = new THREE.LineBasicMaterial({ color: 0x8B5CF6, transparent: true, opacity: 0.18 });
        ...
        vertMat = new THREE.PointsMaterial({ color: 0xA855F7, size: 0.25, transparent: true, opacity: 0.8, blending: THREE.AdditiveBlending });
        ...
        console.error('[BG] Error inicializando THREE.js background:', e);
        document.documentElement.style.backgroundColor = '#07040f';
        document.body.style.background = 'linear-gradient(180deg, #010005, #050015, #0a0030, #150060, #200080)';
    }
})();
